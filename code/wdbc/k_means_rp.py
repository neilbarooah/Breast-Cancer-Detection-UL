...
labels = original["Diagnosis"]
data = scale(original.drop("Diagnosis", 1))
...
pca = GaussianRandomProjection(n_components=n_digits).fit(data)
...
plt.scatter(centroids[:, 0], centroids[:, 1],
            ...
            color='w', zorder=3)
plt.title('K-means clustering on the WDBC dataset (RP-reduced data)\n'
