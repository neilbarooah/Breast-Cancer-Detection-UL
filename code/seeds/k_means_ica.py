...
data = scale(original.drop("Class", 1))
...
pca = FastICA(n_components=n_digits).fit(data)
...
reduced_data = FastICA(n_components=n_digits).fit_transform(data)
...
plt.scatter(centroids[:, 0], centroids[:, 1],
            ...
            color='w', zorder=3)
plt.title('K-means clustering on the Seeds dataset (ICA-reduced data)\n'
